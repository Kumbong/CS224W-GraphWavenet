...
def main():
    ...
    engine = Model(scaler, args.num_nodes, 
                     args.learning_rate, args.weight_decay, device, adj_mx)
    ...
    #testing
    engine.gwnet.load_state_dict(torch.load(args.save+"_epoch_"+str(i)+".pth"))
    outputs = []
